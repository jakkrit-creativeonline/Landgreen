      ...
      return GestureDetector(
        onTap: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  settings: RouteSettings(name: 'CEOรายงานเครดิตทีม'),
          ...
          child: Card(
            child: Column(
              ...
              children: [
                ...
                Stack(
                  children: [
                    HeaderText(text: 'คันที่ ${i+1} ทีม ${res['team_name']}',),
                    Positioned(
                      right: -1,
                      top: -2,
                      child: Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('รายงาน เครดิต แยกข้อมูลงานบริหาร',style: TextStyle(fontSize: 16.0,height: 1),),
                      ],
                    ),
                  ),
                ],
            ...
            //     'ข้อมูลบิลกำหนดชำระวันที่ $firstBillDue ถึง $lastBillDue (นับรวมยอดขายของคนที่ออกด้วย)',style: TextStyle(fontSize: 15),),
            // ),
            // Text('รายงาน เครดิต แยกข้อมูลงานบริหารของ'),
