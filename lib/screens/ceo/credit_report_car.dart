...
class _CreditReportCarState extends State<CreditReportCar> {
  ...
  Widget showDetail(size) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  settings: RouteSettings(name: 'รายงานเครดิตค้างชำระรายทีม'),
                        ...
                        child: Card(
                          child: Column(
                            ...
                            children: [
                              ...
                              Stack(
                                children: [
                                  HeaderText(text: 'คันรถที่ ${i+1} ทีม ${res['team_name']}',),
                                  Positioned(
                                    right: -1,
                                    top: -2,
                                    child: Container(
                                  ...
                                  children: [
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text('ทะเบียน : ${res['car_name']}',style: _baseFontStyle,),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
    ...
    //               crossAxisAlignment: CrossAxisAlignment.start,
    //               children: [
    //                 Text('ทีม : ${res['team_name']}'),
    //                 Text('ทะเบียน : ${res['car_name']}'),
    //                 Text(
    //                   'เก็บครบ : $percent %',
    //                   style: TextStyle(
    //                       color: percent == 0
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('รายงาน เครดิต แยกข้อมูลรายคันรถ',style: TextStyle(fontSize: 24.0,height: 1),),
            ...
            // Text('รายงาน เครดิต แยกข้อมูลรายคันรถ'),
