  ...
  Future<List> fetchShowData({bool isRefresh = false}) async {
    ...
    if (!isRefresh && res != null) {
      ...
      if (response.statusCode == 200) {
        ...
        List obj_car = temp.where((ele) => ele['car_id']==widget.carId).toList();
        print('ดูดาต้าในรถ =>${obj_car[0]['car_sale'].runtimeType}');
            ...
            builder: (context, snap) {
              if (snap.hasData) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (bc, i) {
                      var res = snap.data[i];
                      var work_status = res['Sale_work_status']==1?'':'(ออก)';
                      var percent = 0;
                      if (res['sum_cat1'] > 0) {
                        percent =
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  settings: RouteSettings(name: '(${res['Sale_id']})ดูรายงานเปิดใบสั่งจองรายบุคคล'),
                        ...
                        child: Card(
                          child: Column(
                            ...
                            children: [
                              ...
                              Stack(
                                children: [
                                  HeaderText(text: 'เซล ${res['Sale_name']} $work_status',),
                                  Positioned(
                                    right: -1,
                                    top: -2,
                                    child: Container(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text('${f.SeperateNumber(res['sum_bill'])} บิล',style: _baseFontStyle,),
                                            ],
                                          ),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            ...
                                            children: [
                                              ...
                                              Text('${f.SeperateNumber(res['sum_cat1'])} กระสอบ',style: _baseFontStyle,),
                                            ],
                                          ),
                                        ],
                                      ),
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text('${f.SeperateNumber(res['book_bill'])} บิล',style: _baseFontStyleInCard,),
                                                ],
                                              ),
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  ...
                                                  Text('${f.SeperateNumber(res['book_cat1'] )} กระสอบ',style: _baseFontStyleInCard,),
                                                ],
                                              ),
                                            ],
                                          ),
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text('${f.SeperateNumber(res['sended_bill'])} บิล',style: _baseFontStyleInCard,),
                                                ],
                                              ),
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  Text('จำนวน',style: _baseFontStyleInCard,),
                                                  Text('${f.SeperateNumber(res['sended_cat1'])} กระสอบ',style: _baseFontStyleInCard,),
                                                ],
                                              ),
                                            ],
                                          ),
