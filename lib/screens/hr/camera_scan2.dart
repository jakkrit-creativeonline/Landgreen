...
class CameraScan2 extends StatefulWidget {
  @override
  _CameraScan2State createState() => _CameraScan2State();
}

class _CameraScan2State extends State<CameraScan2> {
  ...
  Widget build(BuildContext context) {
    if (result != null) {
      Future.delayed(Duration.zero, () async {
        ...
        HrServices().setValue('currentCheckOut',saveformat.toString());
