...
class HrBaby extends StatefulWidget {
  final int editStatus;

  const HrBaby({Key key,
  ...
  @override
  _HrBabyState createState() => _HrBabyState();
}

class _HrBabyState extends State<HrBaby> {
  var _day;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('บันทึกลาคลอด', style: TextStyle(
                                      fontSize: 24.0, height: 1),),
                                  Text('กรอกรายละเอียดข้อมูลบันทึกลาคลอด',
                                    style: TextStyle(
