...
class HrHoliday extends StatefulWidget {
  final int editStatus;

  const HrHoliday({Key key,
  ...
  @override
  _HrHolidayState createState() => _HrHolidayState();
}

class _HrHolidayState extends State<HrHoliday> {
  var _day;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('บันทึกลาพักร้อน', style: TextStyle(
                                      fontSize: 24.0, height: 1),),
                                  Text('กรอกรายละเอียดข้อมูลบันทึกลาพักร้อน',
                                    style: TextStyle(
