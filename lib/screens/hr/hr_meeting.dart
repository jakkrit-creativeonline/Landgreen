...
class HrMeeting extends StatefulWidget {
  final int editStatus;

  const HrMeeting({Key key,
  ...
  @override
  _HrMeetingState createState() => _HrMeetingState();
}

class _HrMeetingState extends State<HrMeeting> {
  var _day;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('บันทึกลาฝึกอบรม', style: TextStyle(
                                      fontSize: 24.0, height: 1),),
                                  Text('กรอกรายละเอียดข้อมูลบันทึกลาฝึกอบรม',
                                    style: TextStyle(
