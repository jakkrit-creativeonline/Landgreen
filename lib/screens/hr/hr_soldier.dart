...
class HrSoldier extends StatefulWidget {
  final int editStatus;

  const HrSoldier({Key key,
  ...
  @override
  _HrSoldierState createState() => _HrSoldierState();
}

class _HrSoldierState extends State<HrSoldier> {
  var _day;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('บันทึกลารับราชการทหาร', style: TextStyle(
                                      fontSize: 24.0, height: 1),),
                                  Text('กรอกรายละเอียดข้อมูลบันทึกลารับราชการทหาร',
                                    style: TextStyle(
